...
namespace HTYS.DataAccessLayer
{
    public class MusteriIslem
    {
        ...
        public void Sil(int id) { var musteri = _context.Musteriler.Find(id); if (musteri != null) { _context.Musteriler.Remove(musteri); _context.SaveChanges(); } }
        ...
        {
            return _context.Musteriler.OrderBy(m => m.Ad).ThenBy(m => m.Soyad).ToList();
        }
    }
}
